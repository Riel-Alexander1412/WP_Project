    ...
    <div id="main">
        ...
        <div id="content">
            ...
            <div id="ManageListing" class="content-section" style="display:none;">
                <div class="dashboard-header">
                    <h1 class="dashboard-title"><i class="fas fa-users"></i> Job Management</h1>
                </div>
                <div class="stats-container">
                    <div class="stat-card">
                        <div class="stat-icon" style="background: rgba(13, 71, 161, 0.1); color: var(--primary);">
                        ...
                        <div class="stat-info">
                            ...
                            <div class="stat-title">Total Job</div>
                        </div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-icon" style="background: rgba(13, 71, 161, 0.1); color: var(--primary);">
                        ...
                        <div class="stat-info">
                            ...
                            <div class="stat-title">Active Job</div>
                        </div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-icon" style="background: rgba(13, 71, 161, 0.1); color: var(--primary);">
                        ...
                        <div class="stat-info">
                            ...
                            <div class="stat-title">Suspended Job</div>
                        </div>
                    </div>
                </div>   
                <div class="content-section-data">
